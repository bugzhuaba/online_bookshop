...
<table width="750" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr> 
   ...
   <tr>
   <td colspan="8"><div align="right"><a href="employeeadd.jsp">新建</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="employeesearch.jsp">查询</a></div></td>
   </tr>
   <tr>
...
%>
  <tr>
              ...
              <td><%=s_phone%></td>
			  <td><%=s_task%></td>
			  <td><a href="employeedelete.jsp?op=delete&employeeid=<%=s_employeeid%>&currentpage=<%=i_currentpage%>">删除</a></td>
...
<%if(i_currentpage>1){%>
   <a href="employeelist.jsp?op=firstpage">首页</a>
<%}else{%>首页<%}%>     
   &nbsp;
<%if(i_currentpage>1){%>
   <a href="employeelist.jsp?op=previous&currentpage=<%=i_currentpage%>">上一页</a> 
<%}else{%>上一页<%}%>   
   &nbsp;
<%if(i_currentpage!=i_totalpage){%>
   <a href="employeelist.jsp?op=next&currentpage=<%=i_currentpage%>">下一页</a>
<%}else{%>下一页<%}%>    
   
   &nbsp;
<%if(i_currentpage!=i_totalpage){%>
   <a href="employeelist.jsp?op=lastpage">末页</a>
<%}else{%>末页<%}%>    
